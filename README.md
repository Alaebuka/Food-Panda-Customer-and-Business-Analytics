...
• Revenue performance across cities is quite similar, with Multan only slightly ahead, it’s important to identify what factors are driving its lead — such as better promotions, higher customer engagement, or stronger delivery efficiency. Replicating these strategies in other cities could help raise their revenue levels. Additionally, focusing on boosting performance in Karachi, which recorded the lowest revenue, could help balance overall sales across all locations.

• Pasta generated the highest revenue, efforts should focus on maintaining its strong performance through continued marketing and customer engagement. At the same time, considering that Sandwiches, Pizza, and Burgers also performed well and are close in revenue, introducing combo deals, cross-promotions, or slight menu enhancements could further boost overall sales and help narrow the gap between dishes.

• To maintain consistent revenue, it’s important to analyze what drove the high performance in January and September—such as promotions, seasonal demand, or marketing campaigns—and apply similar strategies during low-performing months like May. Additionally, planning targeted promotions or customer engagement activities in mid-year could help smooth out the revenue dips and sustain steady growth throughout the year.

• Since Delivered orders have the highest total and average count, it’s important to maintain the factors contributing to this strong delivery performance—such as timely dispatch, efficient logistics, and customer satisfaction practices. However, the close figures for Delayed and Cancelled deliveries suggest room for improvement. Focusing on identifying the causes of delays and cancellations—like delivery route issues or order handling problems—and addressing them through process optimization or staff training could significantly enhance overall delivery efficiency. Additionally, building on Multan’s positive contribution (7.17% of total delivered orders) can serve as a model for improving performance in other cities.

• Pizza Hut should focus on improving its customer satisfaction to match its high order volume, perhaps by enhancing service quality or consistency. Burger King should investigate the reasons behind its high cancel rate—such as delays or inaccurate orders—and take corrective measures. KFC’s delivery efficiency can serve as a model for other restaurants to improve overall customer experience and reliability.
