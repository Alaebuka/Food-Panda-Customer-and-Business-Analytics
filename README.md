...
• Since the revenue performance across cities is quite similar, with Multan only slightly ahead, it’s important to identify what factors are driving its lead — such as better promotions, higher customer engagement, or stronger delivery efficiency. Replicating these strategies in other cities could help raise their revenue levels. Additionally, focusing on boosting performance in Karachi, which recorded the lowest revenue, could help balance overall sales across all locations
